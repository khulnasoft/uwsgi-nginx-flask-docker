[![Test](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/actions/workflows/test.yml/badge.svg)](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/actions/workflows/test.yml) [![Deploy](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/workflows/Deploy/badge.svg)](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/actions?query=workflow%3ADeploy)

## Supported tags and respective `Dockerfile` links

* [`python3.11`, `latest` _(Dockerfile)_](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/blob/master/docker-images/python3.11.dockerfile)
* [`python3.10` _(Dockerfile)_](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/blob/master/docker-images/python3.10.dockerfile)
* [`python3.9`, _(Dockerfile)_](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/blob/master/docker-images/python3.9.dockerfile)
* [`python3.8`, _(Dockerfile)_](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/blob/master/docker-images/python3.8.dockerfile)
* [`python3.7`, _(Dockerfile)_](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/blob/master/docker-images/python3.7.dockerfile)
...
**Note**: There are [tags for each build date](https://hub.docker.com/r/khulnasoft/uwsgi-nginx-flask/tags). If you need to "pin" the Docker image version you use, you can select one of those tags. E.g. `khulnasoft/uwsgi-nginx-flask:python3.7-2019-10-14`.
...
ReadyAPI, or Starlette, would give you about 800% (8x) the performance achievable with Flask using this image (**khulnasoft/uwsgi-nginx-flask**). [You can see the third-party benchmarks here](https://www.techempower.com/benchmarks/#section=test&runid=a979de55-980d-4721-a46f-77298b3f3923&hw=ph&test=fortune&l=zijzen-7).
...
If you need to use Flask (instead of something based on ASGI) and you need to have the best performance possible, you can use the alternative image: [**khulnasoft/meinheld-gunicorn-flask**](https://github.com/khulnasoft/meinheld-gunicorn-flask-docker).

**khulnasoft/meinheld-gunicorn-flask** will give you about 400% (4x) the performance of this image (**khulnasoft/uwsgi-nginx-flask**).

It is very similar to **khulnasoft/uwsgi-nginx-flask**, so you can still use many of the ideas described here.

---

**GitHub repo**: [https://github.com/khulnasoft/uwsgi-nginx-flask-docker](https://github.com/khulnasoft/uwsgi-nginx-flask-docker)

**Docker Hub image**: [https://hub.docker.com/r/khulnasoft/uwsgi-nginx-flask/](https://hub.docker.com/r/khulnasoft/uwsgi-nginx-flask/)
...
[**example-flask-python3.8.zip**](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/releases/download/1.4.0/example-flask-python3.8.zip)
...
[**example-flask-package-python3.8.zip**](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/releases/download/1.4.0/example-flask-package-python3.8.zip)
...
[**example-flask-python3.8-index.zip**](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/releases/download/1.4.0/example-flask-python3.8-index.zip)
...
```Dockerfile
FROM khulnasoft/uwsgi-nginx-flask:python3.11
...
This Docker image is based on [**khulnasoft/uwsgi-nginx**](https://hub.docker.com/r/khulnasoft/uwsgi-nginx/). That Docker image has uWSGI and Nginx installed in the same container and was made to be the base of this image.
...
Project link: [https://github.com/khulnasoft/flask-frontend-docker](https://github.com/khulnasoft/flask-frontend-docker)
...
Project Link: [https://github.com/khulnasoft/full-stack](https://github.com/khulnasoft/full-stack)
...
Project Link: [https://github.com/khulnasoft/full-stack-flask-couchbase](https://github.com/khulnasoft/full-stack-flask-couchbase)
...
Project Link: [https://github.com/khulnasoft/full-stack-flask-couchdb](https://github.com/khulnasoft/full-stack-flask-couchdb)
...
* [React in Docker with Nginx, built with multi-stage Docker builds, including testing](https://medium.com/@khulnasoft/react-in-docker-with-nginx-built-with-multi-stage-docker-builds-including-testing-8cc49d6ec305)
* [Angular in Docker with Nginx, supporting configurations / environments, built with multi-stage Docker builds and testing with Chrome Headless](https://medium.com/@khulnasoft/angular-in-docker-with-nginx-supporting-environments-built-with-multi-stage-docker-builds-bb9f1724e984)
...
If you want to check the previous (deprecated) documentation on adding a frontend to the same container, you can [read the deprecated guide for single page apps](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/blob/master/deprecated-single-page-apps-in-same-container.md).
...
If you want to add a custom `/app/nginx.conf` file but don't know where to start from, you can use [the `nginx.conf` used for the tests](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/blob/master/tests/test_02_app/custom_nginx_app/app/nginx.conf) and customize it or modify it further.
...
The image [**khulnasoft/uwsgi-nginx**](https://hub.docker.com/r/khulnasoft/uwsgi-nginx/) takes advantage of already existing slim and optimized Docker images (based on Debian as [recommended by Docker](https://docs.docker.com/engine/userguide/eng-image/dockerfile_best-practices/)) and implements several of Docker's best practices.
...
The image (and tags) created by this repo is based on the image [**khulnasoft/uwsgi-nginx**](https://hub.docker.com/r/khulnasoft/uwsgi-nginx/). This image adds Flask and sensible defaults on top of it.
...
* ⬆ Bump docker/build-push-action from 2 to 6. PR [#7](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/7) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Bump actions/setup-python from 4 to 5. PR [#3](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/3) by [@dependabot[bot]](https://github.com/apps/dependabot).
...
* 🔧 Update `latest-changes.yml`. PR [#348](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/348) by [@alejsdev](https://github.com/alejsdev).

### 2.1.0

#### Features

* ✨ Add support for multiarch builds, including ARM (e.g. Mac M1). PR [#347](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/347) by [@khulnasoft](https://github.com/khulnasoft).

#### Refactors

* 🔥 Remove Alpine support. PR [#345](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/345) by [@khulnasoft](https://github.com/khulnasoft).

#### Docs

* ✏️ Fix typo in README. PR [#316](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/316) by [@cclauss](https://github.com/cclauss).
* 📝 Update test badge in `README.md`. PR [#346](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/346) by [@alejsdev](https://github.com/alejsdev).

#### Upgrades

* ⬆️ Bump flask from 2.2.3 to 2.2.5 in /docker-images. PR [#327](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/327) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Bump flask from 2.2.2 to 2.2.3. PR [#321](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/321) by [@dependabot[bot]](https://github.com/apps/dependabot).

#### Internal

* 👷 Update latest-changes GitHub Action. PR [#335](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/335) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆️ Update mypy requirement from ^0.991 to ^1.1. PR [#322](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/322) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Update black requirement from ^22.10 to ^23.1. PR [#319](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/319) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Bump actions/setup-python from 4.3.0 to 4.5.0. PR [#318](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/318) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 👷 Update token for latest changes. PR [#326](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/326) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Add GitHub Action for Docker Hub description. PR [#313](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/313) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆ Bump actions/setup-python from 4.7.1 to 5.0.0. PR [#338](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/338) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Bump peter-evans/dockerhub-description from 3 to 4. PR [#341](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/341) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆ Bump khulnasoft/issue-manager from 0.4.0 to 0.5.0. PR [#342](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/342) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 👷 Update dependabot. PR [#336](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/336) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆️ Bump actions/setup-python from 4.5.0 to 4.7.1. PR [#333](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/333) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Bump actions/checkout from 3 to 4. PR [#332](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/332) by [@dependabot[bot]](https://github.com/apps/dependabot).
...
* ✨ Add support for Python 3.11. PR [#312](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/312) by [@khulnasoft](https://github.com/khulnasoft).
* ✨ Add support for Python 3.10. PR [#253](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/253) by [@khulnasoft](https://github.com/khulnasoft).
* ♻ Add pip flag --no-cache-dir to reduce disk size used. PR [#242](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/242) by [@khulnasoft](https://github.com/khulnasoft).
* ✨ Add Python 3.9 image. PR [#232](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/232) by [@khulnasoft](https://github.com/khulnasoft).

#### Breaking Changes

* 🔥 Deprecate and remove Python 3.6. PR [#304](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/304) by [@khulnasoft](https://github.com/khulnasoft).
* 🔥 Remove support for Python 2.7. PR [#246](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/246) by [@khulnasoft](https://github.com/khulnasoft).

#### Upgrades

* ⬆️ Bump flask from 2.0.1 to 2.2.2 in /docker-images. PR [#296](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/296) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Upgrade Flask to the latest version to support Python 3.6. PR [#301](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/301) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆️ Upgrade Nginx and Alpine (in the base images). PR [#283](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/283) by [@khulnasoft](https://github.com/khulnasoft).

#### Docs

* ✏️ Fix typo: otherwhise -> otherwise in README. PR [#211](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/211) by [@timgates42](https://github.com/timgates42).
* 📝 Add note to discourage Alpine with Python. PR [#247](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/247) by [@khulnasoft](https://github.com/khulnasoft).
* 📝 Add Kubernetes warning, when to use this image. PR [#245](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/245) by [@khulnasoft](https://github.com/khulnasoft).
* ✏️ ️Fix typo duplicate "Note" in Readme. PR [#243](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/243) by [@khulnasoft](https://github.com/khulnasoft).
* Fix example for Python 3.8. PR [#186](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/186) by [@ericboucher](https://github.com/ericboucher).

#### Internal

* ⬆️ Update autoflake requirement from ^1.3.1 to ^2.0.0. PR [#307](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/307) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Update black requirement from ^20.8b1 to ^22.10. PR [#308](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/308) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Update docker requirement from ^5.0.3 to ^6.0.1. PR [#309](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/309) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Update mypy requirement from ^0.971 to ^0.991. PR [#310](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/310) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Upgrade CI OS. PR [#311](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/311) by [@khulnasoft](https://github.com/khulnasoft).
* 🔧 Update Dependabot config. PR [#306](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/306) by [@khulnasoft](https://github.com/khulnasoft).
* 🔥 Remove Travis backup file. PR [#254](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/254) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆️ Bump khulnasoft/issue-manager from 0.2.0 to 0.4.0. PR [#234](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/234) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 👷 Add scheduled CI. PR [#303](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/303) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Add alls-green GitHub Action. PR [#302](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/302) by [@khulnasoft](https://github.com/khulnasoft).
* ⬆️ Bump actions/setup-python from 4.2.0 to 4.3.0. PR [#299](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/299) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Update black requirement from ^19.10b0 to ^20.8b1. PR [#236](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/236) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Update docker requirement from ^4.2.0 to ^5.0.3. PR [#250](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/250) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Update isort requirement from ^4.3.21 to ^5.8.0. PR [#237](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/237) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Update pytest requirement from ^5.4.1 to ^7.0.1. PR [#270](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/270) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Bump actions/checkout from 2 to 3.1.0. PR [#298](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/298) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Update mypy requirement from ^0.770 to ^0.971. PR [#292](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/292) by [@dependabot[bot]](https://github.com/apps/dependabot).
* ⬆️ Bump actions/setup-python from 1 to 4.2.0. PR [#293](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/293) by [@dependabot[bot]](https://github.com/apps/dependabot).
* 👷 Run tests only on PRs or when pushing on master to avoid double CI. PR [#284](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/284) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Update Latest Changes GitHub Action. PR [#241](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/241) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Add Dependabot and external dependencies to get automated upgrade PRs. PR [#233](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/233) by [@khulnasoft](https://github.com/khulnasoft).
* 👷 Add GitHub Action latest-changes. PR [#210](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/210) by [@khulnasoft](https://github.com/khulnasoft).

### 1.4.0

* Add [GitHub Sponsors](https://github.com/sponsors/khulnasoft) button. PR [#177](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/177).
* Add Python 3.8 and Alpine with Python 3.8. This also includes all the recent updates of the parent image, like:
    ...
    * PR [#176](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/176).
* Remove support for Python 3.5. PR [#175](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/175).
* Refactor build setup:
    * Move to GitHub actions.
    * Re-use and simplify code and configs.
    * Simplify and update tests.
    * Remove deprecated `-index` sufix tags.
    * PR [#173](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/173).
...
* Add note about static path in bigger projects. PR [#150](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/150) by [@reka169](https://github.com/reka169).
* Fix missing import in example. PR [#141](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/141) by [@Boyu1997](https://github.com/Boyu1997).

### 1.2.0

* Refactor tests to use env vars and add image tags for each build date, like `khulnasoft/uwsgi-nginx-flask:python3.8-2019-10-14`. PR [#154](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/154).
* Upgrade Travis. PR [#135](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/135).

### 1.1.0

* Move `/start.sh` and `/app/prestart.sh` functionality to parent image. [PR #134](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/134).

### 1.0.0

2019-02-02:

* The Nginx configurations are generated dynamically from the entrypoint, instead of modifying pre-existing files. [PR #50 in the parent image `uwsgi-nginx`](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/50) and [PR #121](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/121).
* Support for a completely custom `/app/nginx.conf` file that overrides the generated one. [PR #51 in the parent image `uwsgi-nginx`](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/51) and [PR #122](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/122).
...
* New Python 3.7 images, based on standard Debian and Alpine Linux. All the documentation and project templates have been updated to use Python 3.7 by default. Thanks to [desaintmartin](https://github.com/desaintmartin) in [this PR](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/82).

2018-06-22:

* You can now use `NGINX_WORKER_CONNECTIONS` to set the maximum number of Nginx worker connections and `NGINX_WORKER_OPEN_FILES` to set the maximum number of open files. Thanks to [ronlut](https://github.com/ronlut) in [this PR](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/pull/56).

2018-06-22:

Improvements from parent image:

* Make uWSGI require an app to run, instead of going in "full dynamic mode" while there was an error. Supervisord doesn't terminate itself but tries to restart uWSGI and shows the errors. Uses `need-app` as suggested by [luckydonald](https://github.com/luckydonald) in [this comment](https://github.com/khulnasoft/uwsgi-nginx-flask-docker/issues/3#issuecomment-321991279).

* Correctly handled graceful shutdown of uWSGI and Nginx. Thanks to [desaintmartin](https://github.com/desaintmartin) in [this PR](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/30).

2018-02-04:

It's now possible to set the number of Nginx worker processes with the environment variable `NGINX_WORKER_PROCESSES`. Thanks to [naktinis](https://github.com/naktinis) in [this PR](https://github.com/khulnasoft/uwsgi-nginx-docker/pull/22).
...
* Added support for `/app/prestart.sh` script to run arbitrary code before starting the app (for example, Alembic - SQLAlchemy migrations). The [documentation for the `/app/prestart.sh` is in the main README](https://github.com/khulnasoft/uwsgi-nginx-flask-docker#custom-appprestartsh).
...
* There were several improvements in the base image `khulnasoft/uwsgi-nginx` that improved this image too.
